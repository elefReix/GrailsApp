...
class gsp_appindex_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(23)
invokeTag('actionSubmit','g',124,['value':("Get greeting")],-1)
printHtmlPart(24)
})
invokeTag('form','g',125,['controller':("Test"),'action':("greeting")],2)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1504566455231L
